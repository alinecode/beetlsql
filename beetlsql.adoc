...
* 社区 http://ibeetl.com
* qq群 219324263
* 当前版本 2.4.0 (190K), 另外还需要beetl(http://git.oschina.net/xiandafu/beetl2.0/attach_files) 包
**********************************************************************
...
# globalUse 参数是其他文件的globalUse，如#use("share.accessControl")#,将访问share.md(sql)文件的accessControl片段
