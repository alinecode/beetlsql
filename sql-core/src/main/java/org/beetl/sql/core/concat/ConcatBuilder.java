...
public class  ConcatBuilder  {
	...
	public ConcatBuilder testVarOrDefault(String varName,String defaultValue){
		ctx.templateEngine.genTestVarOrDefault(this,varName,defaultValue);
		return this;
	}
	...
	public ConcatBuilder testRealVar(String varName,String realVal){
        ctx.templateEngine.genTestRealVar(this,varName,realVal);
        return this;
    }
	...
	public ConcatBuilder appendWhereTagStart(){
		this.cr();
		ctx.templateEngine.genWhereStart(this);
		return this;
	}
	public ConcatBuilder appendWhereTagEnd(){
		this.cr();
		ctx.templateEngine.genWhereEnd(this);
		return this;
	}
