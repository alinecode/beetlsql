...
public class SQLSource {
	 ...
	 */
	public AutoSQLEnum autoSQLEnum = null;


	public int[] columnToProperty = null;
	...
	public AutoSQLEnum getAutoSQLEnum() {
		return autoSQLEnum;
	}

	public void setAutoSQLEnum(AutoSQLEnum autoSQLEnum) {
		this.autoSQLEnum = autoSQLEnum;
	}
	...
	public void setColumnToProperty(int[] columnToProperty) {
